...
fn main() {
    ...
    let (r, c) = p.screen().cursor_position();
    println!(
        "After FULL_MODE_RESET: row={} col={} hide={}",
        r,
        c,
        p.screen().hide_cursor()
    );
    ...
    p.process(b"\x1b[0m\x1b[?25h\x1b[?1l\x1b[?9l\x1b[?47l\x1b[?1000l\x1b[?1002l\x1b[?1003l\x1b[?1005l\x1b[?1006l\x1b[?2004l");
    println!(
        "After 2nd FULL_MODE_RESET: hide={}",
        p.screen().hide_cursor()
    );
    ...
    println!(
        "p2 after hide on normal: hide={}",
        p2.screen().hide_cursor()
    );
